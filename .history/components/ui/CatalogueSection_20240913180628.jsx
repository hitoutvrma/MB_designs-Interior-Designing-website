    ...
    <div className='grid gap-8 lg:grid-cols-4 md:grid-cols-2 lg:gap-0 divide-gray-300'>
      {items.map((item)=>(
        ...
        >
            ...
            <div className='absolute top-0 p-8 w-full bg-white text-black bg-opacity-60 backdrop-blur'>
                <div className='flex justify-between pb-4'>
                    ...
                    <a className='inline-flex items-center font-medium' href="">See details <TbArrowNarrowRight/></a>
            </div>
        </div>
      ))}
    </div>
