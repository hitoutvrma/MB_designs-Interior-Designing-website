...
const Footer = () => {
  return (
    ...
    <div class="flex justify-between  border-t-2 border-t-orange-600  backdrop-blur-lg px-[14vw] py-[3vh] text-[17px] ">
  <div>
    <head>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"/>

    </head>
    <h1 class="pb-5 sm:text-4xl tracking-tighter">Follow us</h1>
    <div className='flex gap-x-6 pb-2 sm:text-4xl'>
  ...
  <div>
    <h1 class="pb-5 sm:text-4xl tracking-tighter">Contact us</h1>
    <div class="sm:flex flex-col gap-x-2">
      <div>
      <svg class="text" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="gray">
    ...
    <div class="sm:flex grid gap-x-2">
  ...
  <div className='flex items-center justify-center p-1 text-sm bg-orange-700 text-white border-t-orange-600'>Website is created and Managed by bitCheat</div>
</div>
