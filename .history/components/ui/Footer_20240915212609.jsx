...
const Footer = () => {
  return (
    ...
    <div class="flex justify-between  border-t-2 border-t-orange-600  backdrop-blur-lg px-[14vw] py-[4vh] text-[17px] ">
  <div>
    <head>
  ...
  <div className='flex items-center justify-center p-1 border border-t-2 border-t-orange-600'>Website is created and Managed by bitCheat</div>
</div>
