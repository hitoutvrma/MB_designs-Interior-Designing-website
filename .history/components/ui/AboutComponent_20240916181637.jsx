...
const AboutComponent = () => {
  return (
    <div className="sm:container py-12 xl:py-24 h-[auto]">
            <div className="grid lg:grid-cols-2 place-items-center">
                ...
                <div className="items-center">
                    <h2 className='sm:px-12 px-8 py-4 text-3xl font-extrabold leading-tight lg:text-5xl'>We are award winning company</h2>
