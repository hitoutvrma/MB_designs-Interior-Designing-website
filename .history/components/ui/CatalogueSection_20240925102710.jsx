    ...
    <div className='grid gap-8 lg:grid-cols-4 md:grid-cols-2 lg:gap-0 divide-red-700'>
      {items.map((item)=>(
        ...
        >
            ...
            <div className='inset-0 bg-red-400 hidden flex-col items-center justify-end md:flex md:absolute gap-32 pb-16 text-xl group-hover:translate-y-full transition duration-300 ease-in-out border-b-2 md:border-b-0'>
