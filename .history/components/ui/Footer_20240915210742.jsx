...
const Footer = () => {
  ...
  <div>
    ...
    <a href="https://instagram/hitoutvrma" className="text-gray-600 hover:text-pink-500 transition-transform duration-300 transform hover:scale-110"><i class="fa-brands fa-instagram" ></i></a>
      ...
      <a 
      href="https://x.com/hitesh_404"
      className="text-gray-600 hover:text-black transition-transform duration-300 transform hover:scale-110"
    >
      <i className="fa-brands fa-x fa-2x"></i> {/* Use the Font Awesome X icon */}
    </a>
    </div>
