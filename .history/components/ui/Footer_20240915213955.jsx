...
const Footer = () => {
  ...
  <div className='flex items-center justify-center p-1 border border-t-2 bg-orange-700 text-white border-t-orange-600'>Website is created and Managed by bitCheat</div>
</div>
