...
const Footer = () => {
  return (
    ...
    <div class="sm:flex justify-between  border-t-2 border-t-orange-600  backdrop-blur-lg sm:px-[14vw] px-12 py-[3vh] text-[17px] ">
  <div className='mb-8 sm:mb-0'>
    <head>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"/>

    </head>
    <h1 class="pb-5 text-4xl tracking-tighter">Follow us</h1>
    ...
    <div className='sm:block hidden'>&copy; 2024-25 YOGENDRA DESIGNER. All rights reserved</div>
  </div>
  <div>
    <h1 class="pb-5 text-4xl tracking-tighter">Contact us</h1>
