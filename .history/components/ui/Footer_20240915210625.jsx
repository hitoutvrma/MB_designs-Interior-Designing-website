...
const Footer = () => {
  return (
    ...
    <div class="flex justify-between  px-[14vw] py-[8vh] text-[17px] ">
  <div>
    <head>
    ...
    <a href="https://instagram/hitoutvrma" className="text-gray-600 hover:text-pink-500 transition-transform duration-300 transform hover:scale-110"><i class="fa-brands fa-instagram" ></i></a>
      <a href="https://www.linkedin.com/in/hitesh-verma-3695b0254/" className="text-gray-600 hover:text-blue-500 transition-transform duration-300 transform hover:scale-110"><i class="fa-brands fa-linkedin"></i></a>
