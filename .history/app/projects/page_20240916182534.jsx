    ...
    <div className="container grid lg:grid-cols-2 gap-8 py-8">
      {
        projcets.map((project) => (
          <div key={project.id} className="relative overflow-hidden rounded-xl group"> 
            ...
            <div className="absolute bottom-0 right-5 bg-white/90 dark:bg-black/40 flex-col items-center justify-end w-96 gap-32 p-12 text-xl transition duration-300 ease-in-out translate-y-full from-transparent to-black group-hover:translate-y-0 ">
