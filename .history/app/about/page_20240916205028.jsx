...
const page = () => {
  return (
    <div>
      ...
      <Button className="flex w-full items-center px-15 py-6 text-white rounded-full shadow-lg hover:bg-gray-800 hover:ring-2 hover:ring-gray-950 ring-offset-2">Read More<TbArrowUpRight className="w-5 h-5 ml-2"/></Button>
