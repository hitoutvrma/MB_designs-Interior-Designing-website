  ...
  return (
    <div>
      ...
      <div className='lg:py-20 lg:relative'>
        <div className='pt-8 lg:absolute left-[43vw] top-[33vh] pb-4'>
          <h1 className='text-5xl font-bold tracking-wider text-center uppercase'>Team</h1>
        </div>
        <div className='grid py-8 gap-20 lg:grid-cols-3'>
          <div className='border-2 border-primary'>
            <div className='p-4 text-center bg-gray-100 aspect-square dark:bg-slate-600 -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3'>
              ...
              <p className='text-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo ab impedit repudiandae!</p>
